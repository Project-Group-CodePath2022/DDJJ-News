...
public class Dialog extends DialogFragment {
    ...
    public android.app.Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        al.setNegativeButton("NO", (dialogInterface, i) -> listener.onNegativeClick(dialogInterface));

        al.setPositiveButton("Yes", (dialogInterface, i) -> listener.onPositiveClick(dialogInterface));
